...
public class Enemy {
    ...
    public void draw(java.awt.Graphics2D g) {
        ...
        Color adjustedEnemyColor = new Color(enemyColor.getRed(), enemyColor.getGreen(), enemyColor.getBlue(), 150);
        Color adjustedBoundaryColor = new Color(enemyBoundaryColor.getRed(), enemyBoundaryColor.getGreen(), enemyBoundaryColor.getBlue(), 155);
        ...
        if (health > 0 && setFlash && startFlashTimer != 0) {
            ...
            g.setColor(adjustedBoundaryColor.brighter());
            g.drawOval((int) x, (int) y - r, 2 * r, 2 * r);
            g.setStroke(new java.awt.BasicStroke(1));
        } else {
            g.setColor(adjustedEnemyColor);
            g.setStroke(new java.awt.BasicStroke(2));
            g.fillOval((int) x, (int) y - r, 2 * r, 2 * r);
            g.setColor(adjustedBoundaryColor);
            g.drawOval((int) x, (int) y - r, 2 * r, 2 * r);
            g.setStroke(new java.awt.BasicStroke(1));
        }
